...
spark-submit --class harsha.grab_spark_streaming.SparkStreaming --master yarn --deploy-mode cluster --num-executors 2 --executor-cores 2 --executor-memory 3g --driver-memory 1g --driver-cores 1 grab_spark_streaming-1.0-SNAPSHOT.jar s3://grab-test-data/grab_data_processing.properties
